...
| Report a vulnerability | [`SECURITY.md`](SECURITY.md) (privately, please) |
| Collaborate on a corpus, benchmark, or second implementation | Email the authors listed in [`CITATION.cff`](CITATION.cff) |

The authors maintain this repository alongside research work, so replies may take a few days. Issues with exact file names, commands, and measured evidence get resolved fastest.
